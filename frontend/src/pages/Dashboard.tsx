  ...
  return (
    <div className="space-y-6">
      ...
      <div className="p-6 bg-white rounded-lg shadow">
        ...
        <div className="p-6 text-white rounded-lg bg-gradient-to-r from-yellow-400 to-orange-500">
          <h3 className="text-sm font-medium opacity-90">
            Total Revenue (Estimated)
          </h3>
          <p className="text-4xl font-bold">{stats.totalRevenue}</p>
          <p className="mt-2 text-sm opacity-80">
            Based on franchise operations
          </p>
        </div>

        <div className="p-6 bg-white rounded-lg shadow">
          <h3 className="text-sm font-medium text-gray-500">Active Status</h3>
          <p className="text-3xl font-bold text-green-600">
